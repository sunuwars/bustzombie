  ...
  render() {
    ...
    return (
      <div>
         ...
         && (
          <div>
            <div className="game-container">
              <Btn zombiesAlive={this.state.zombiesAlive} increment={this.increment} decrement = {this.decrement} firstZombieAppeared={this.setFirstZombieAppeared}/>
              <Btn zombiesAlive={this.state.zombiesAlive} increment={this.increment} decrement = {this.decrement} firstZombieAppeared={this.setFirstZombieAppeared}/>
              <Btn zombiesAlive={this.state.zombiesAlive} increment={this.increment} decrement = {this.decrement} firstZombieAppeared={this.setFirstZombieAppeared}/>
              <Btn zombiesAlive={this.state.zombiesAlive} increment={this.increment} decrement = {this.decrement} firstZombieAppeared={this.setFirstZombieAppeared}/>
              <Btn zombiesAlive={this.state.zombiesAlive} increment={this.increment} decrement = {this.decrement} firstZombieAppeared={this.setFirstZombieAppeared}/>
        ...
        {this.state.zombiesAlive == 0 && this.state.firstZombieAppeared  && (
          <YouHaveWon />
        )
       }
      </div>
